...
def run_experiment(map_name, grid, start, goal, apply_weight=False, optimal_cost=None, scenario_index=None):
    heuristics = {
        "manhattan": manhattan,
        "euclidean": euclidean,
        "diagonal": diagonal,
...
if __name__ == "__main__":
    ...
    if args.source == 'custom':
        ...
        print("Running on Moving AI benchmark maps")
    ...
    df.to_csv("results/combined_metrics_small.csv", index=False)